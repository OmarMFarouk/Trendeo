...
class _SignInFormState extends State<SignInForm> {
  ...
  void singIn(BuildContext context, bool status) {
    // confetti.fire();
    setState(() {
      isShowConfetti = true;
      isShowLoading = true;
    ...
    Future.delayed(
      ...
      () {
        if (_formKey.currentState!.validate() && status == true) {
          success.fire();
          Future.delayed(
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AuthCubit, AuthStates>(listener: (context, state) {
      state is AuthSuccess ? singIn(context, true) : null;
      state is AuthError ? singIn(context, false) : null;
